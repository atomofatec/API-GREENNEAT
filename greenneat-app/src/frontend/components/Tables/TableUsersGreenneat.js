...
const rows = [
    createData(309751532, 'nome1@', 393130287, 'Nominho1', 'Nome1'),
    createData(452852981, 'nome2@', 253250130, 'Nominho2', 'Nome2'),
    createData(261086275, 'nome3@', 163855360, 'Nominho3', 'Nome3'),
    createData(414303762, 'nome4@', 791824536, 'Nominho4', 'Nome4'),
  ];
